...
# Usage
~~Run face2age_20260826_wrinkle_region_analysis_spline_openVer_en_1.py.~~ Due to patent application issues, the Python code will be disclosed after the patent application is filed.
